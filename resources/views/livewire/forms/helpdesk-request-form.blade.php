<form wire:submit.prevent="submit" @class(['form helpdesk-request-form', 'success' => $submitted])>
    @if($submitted)
        ...
        <p class="mt-1">
            Thank you. Your ticket has been submitted. You should hear back from us shortly.
        </p>
    ...
    @else
        ...
        <input type="hidden" name="requestTypeId" id="requestTypeId" wire:model.live="requestTypeId" />
        ...
        <div class="helpdesk-request-form__footer">
            <button type="button" class="button button--secondary" @click="$dispatch('close-modal', { modal: 'create-helpdesk-request' })">
                Cancel
            </button>

            <button type="submit" class="button button--primary" wire:target="submit" wire:loading.attr="disabled">
                Submit
